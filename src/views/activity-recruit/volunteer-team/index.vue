<template>
  <div class="cultivate-list volunteer-team">
    <ul class="cultivate-list-content">
      <p class="title">志愿团队</p>
    ...
    <img src="static/images/common/top14.png" style="width: 1000px; margin:10px auto;display: block" alt="">
